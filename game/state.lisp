...
(defun @sprites (&key (dir "assets"))
  ...
  (make-sprites
   ...
   :logo      (raylib:load-texture (p:join dir "logo.png"))
   :road      (raylib:load-texture (p:join dir "road.png"))
   :test      (raylib:load-texture (p:join dir "test.png"))
   :ground    (raylib:load-texture (p:join dir "lighter-ground.png"))
   :shadow    (raylib:load-texture (p:join dir "shadow.png"))
   :su-logo   (raylib:load-texture (p:join dir "su-logo.png"))
   :controller (raylib:load-texture (p:join dir "controller.png"))
   :blob-shadow (raylib:load-texture (p:join dir "blob-shadow.png"))
   :missile-shadow (raylib:load-texture (p:join dir "missile-shadow.png"))
   :building-shadow (raylib:load-texture (p:join dir "building-shadow.png"))))
...
(defun @music (&key (dir "assets/sound"))
  (make-music
   :intro (raylib:load-music-stream (p:join dir "BossIntro.ogg"))
   :main  (raylib:load-music-stream (p:join dir "BossMain.ogg"))))
