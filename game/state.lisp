...
(defstruct game
  ...
  (shots-made 0 :type fixnum)
  (shots-hit  0 :type fixnum)
  (shot-counted nil :type boolean)
...
(defun reset-game! (game)
  ...
  (setf (game-shots-made game) 0)
  (setf (game-shots-hit game) 0)
  (setf (game-shot-counted game) nil)
